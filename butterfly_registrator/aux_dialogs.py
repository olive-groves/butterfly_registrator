...
class PixelUnitConversionInputDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, unit="mm", px_conversion=1.0, unit_conversion=1.0, px_per_unit=None):
        ...
        self.setWindowTitle("Set pixel-per-" + unit + " conversion for the view")
        ...
        dialog_string = "Enter the pixel and " + self.unit_longform + " length for a known distance in the view's main image."
        dialog_string = dialog_string + "\n\n" + "Tip: First use a pixel ruler to measure a known distance in the view (such as \na 5-centimeter-long calibration ruler or the width of the canvas) and then \nenter the distance in pixels and " + self.unit_longform + "s here.\n"
