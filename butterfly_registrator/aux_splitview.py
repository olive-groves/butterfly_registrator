...
class SplitView(QtWidgets.QFrame):
    ...
    Args:
        ...
        transform_mode_smooth (bool): True to smooth (upsample) pixels when overzoomed; False to not smooth.
        allow_main_opacity (bool): True to allow main pixmap opacity to change (2x memory to retain original); False to not allow (1x memory).
    """

    def __init__(self, pixmap_main_topleft=None, filename_main_topleft=None, name=None, 
            pixmap_topright=None, pixmap_bottomleft=None, pixmap_bottomright=None, 
            transform_mode_smooth=False, 
            allow_main_opacity=True):
        super().__init__()
        ...
        self._pixmap_base_original_exists = allow_main_opacity
    ...
    def pixmap_main_topleft(self, pixmap_main_topleft):
        if pixmap_main_topleft is not None:
            ...
            if self._pixmap_base_original_exists:
                print("Create base")
    ...
    def set_opacity_base(self, percent):
        ...
        if not self._pixmap_base_original_exists:
            return
